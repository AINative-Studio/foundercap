"""Unit tests for enhanced Crunchbase service functionality."""
import pytest
...
class TestEnhancedCrunchbaseService:
    """Test suite for enhanced Crunchbase service functionality."""
    ...
    @pytest.fixture
    def crunchbase_service(self, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_get_company_funding_with_detailed_rounds(self, crunchbase_service):
        ...
        # Mock cache
        crunchbase_service._get_cached = AsyncMock(return_value=None)
        crunchbase_service._set_cached = AsyncMock()
    ...
    @pytest.mark.asyncio
    async def test_get_investor_portfolio(self, crunchbase_service):
        ...
        assert crunchbase_service._set_cached.called
    
    @pytest.mark.asyncio
    async def test_get_company_funding_api_error(self, crunchbase_service):
