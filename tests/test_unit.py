#!/usr/bin/env python3
"""Unit tests for individual components without full app setup."""
...
class TestDiffEngine:
    """Test the diff engine component."""
...
class TestLinkedInConfig:
    ...
    def test_linkedin_config_with_custom_values(self):
...
class TestLinkedInModels:
    ...
    def test_company_info_model(self):
        ...
        from app.services.linkedin.models import CompanyInfo
...
class TestLinkedInExceptions:
    """Test LinkedIn exceptions."""
    
    def test_linkedin_scraping_error(self):
    ...
    def test_linkedin_not_found_error(self):
